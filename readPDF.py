...
subject = 'CREATE TABLE  if not exists  subject (name VARCHAR(255), lvl VARCHAR(255), lecturer varchar (255), lang varchar (255), hours varchar (1000),points varchar (255))'

myCursor.execute(subject)


insertStatement = 'insert into  subject(name, lvl, lecturer, lang, hours, points)  values(%s, %s, %s, %s, %s, %s)'
